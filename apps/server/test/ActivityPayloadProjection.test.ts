...
describe("projectActivityPayload", () => {
  ...
  it("keeps the web client's derived output identical for every tool item type", () => {
    // The projection must be invisible to the client derivation: rendering
    // from projected payloads matches rendering from raw history.
