...
export class BootServiceInstallError extends Schema.TaggedErrorClass<BootServiceInstallError>()(
  ...
  override get message(): string {
    return "Could not set up the OpenBuff background service.";
  }
}
...
>()("@princetheprogrammerbtw/openbuff/cloud/bootService") {}
            ...
            Effect.mapError(
              (cause) =>
                new PinnedRuntimeInstallError({
                  step: "verifying the pinned openbuff runtime",
                  cause,
                }),
            ),
