...
const AgentSpawnCtaRow = memo(function AgentSpawnCtaRow(props: { workEntry: TimelineWorkEntry }) {
  ...
  return (
    <button
      ...
      className="-mx-1 flex w-full items-center gap-2 rounded-md border border-border/60 bg-card/50 px-2.5 py-1.5 text-left text-[13px] transition hover:bg-accent/50 [transition-timing-function:var(--ease-spring)] [transition-duration:var(--duration-fade)]"
    >
