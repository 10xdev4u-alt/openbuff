...
/**
 * The palette OpenBuff wears with no theme installed, captured from the app's
...
/**
 * The standard OpenBuff look as a theme palette, for seeding a new theme when
...
/**
 * The status colors OpenBuff shows without a theme, read from the app's own
