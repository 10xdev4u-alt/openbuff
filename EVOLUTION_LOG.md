...
**What I tried** | Release v0.0.37 per runbook. The Publish gate — green three days earlier — died three times in "Stage publish tree": run 1 silently CANCELLED mid-flight, run 2 sat 23+ minutes, run 3 (after I hardened the workflow) timed out loudly at 12 minutes.
